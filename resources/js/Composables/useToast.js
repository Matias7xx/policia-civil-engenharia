...
export function useToast() {
    ...
    const getToastComponent = () => {
        ...
        console.warn('Toast component não encontrado. Certifique-se de que o componente Toast está registrado globalmente.');
        return null;
    };
    ...
    const toast = {
        ...
        serverError: (message = 'Erro interno do servidor. Tente novamente.', options = {}) => {
