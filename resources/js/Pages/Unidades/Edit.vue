                    ...
                    <div class="p-4 sm:p-8 bg-white border-b border-gray-200">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <div class="mt-2 text-sm text-amber-700">
                                        <p>
                                            Você está alterando uma unidade já cadastrada. 
                                            <span class="font-medium">As alterações serão salvas imediatamente ao clicar em "Atualizar" em cada aba.</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <h4 class="text-sm font-medium text-gray-800">💡 Dicas de Edição</h4>
                                    <div class="mt-1 text-sm text-gray-600">
                                        <ul class="list-disc list-inside space-y-1">
                                            <li>Cada aba pode ser editada independentemente</li>
                                            <li>As alterações são salvas imediatamente ao confirmar</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
