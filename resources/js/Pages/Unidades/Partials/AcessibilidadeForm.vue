...
const checkOptions = [
    {
        ...
        description:
            "Rampas para acesso de cadeirantes e pessoas com mobilidade reduzida",
    },
    {
        id: "corrimao",
        label: "Corrimão",
        description: "Corrimãos em escadas e rampas",
    },
    {
        id: "piso_tatil",
        label: "Piso Tátil",
        description: "Piso com sinalização tátil para deficientes visuais",
    },
    {
        id: "banheiro_adaptado",
        label: "Banheiro Adaptado",
        description: "Banheiros adaptados para cadeirantes",
    },
    {
        id: "elevador",
        label: "Elevador",
        description: "Elevador para acesso a andares superiores",
    },
    {
        id: "sinalizacao_braile",
        label: "Sinalização em Braille",
        description: "Sinalizações em Braille para deficientes visuais",
    },
];
</script>
        ...
        >
            <div class="bg-white p-6 rounded-lg shadow-xl">
                <div class="flex items-center space-x-4">
                    <div
                        class="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-[#bea55a]"
                    ></div>
                    <p class="text-lg font-semibold">
                        Salvando dados de acessibilidade...
                    </p>
                </div>
            </div>
        </div>
            ...
            >
                <div class="text-sm text-gray-600">
                    <svg
                        ...
                        class="h-5 w-5 inline text-yellow-500"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                    >
                        <path
                ...
                <div class="flex items-center">
                    ...
                    <PrimaryButton
                        :class="{
                            ...
                            'bg-[#bea55a] hover:bg-[#d4bf7a]': !form.processing,
                        }"
