...
const hasUnidadeDetails = computed(
    () => props.unidade && Object.keys(props.unidade).length > 0,
);
const hasAcessibilidade = computed(
    () => props.acessibilidade && Object.keys(props.acessibilidade).length > 0,
);
const hasInformacoes = computed(
    () => props.informacoes && Object.keys(props.informacoes).length > 0,
);
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <span class="text-white text-xl font-semibold pl-2"
                        >{{ team.name.toUpperCase() }} - Detalhes da Unidade
                        Policial</span
                    >
                </div>
