...
<template>
    ...
    >
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div
                class="absolute -top-20 -right-20 w-96 h-96 bg-[#f5e6b8] rounded-full opacity-10 blur-3xl"
            ></div>
            <div
                class="absolute -bottom-20 -left-20 w-96 h-96 bg-[#bea55a] rounded-full opacity-10 blur-3xl"
            ></div>
        </div>
        ...
        <div
            ref="logoRef"
            class="relative z-10 mb-8 flex flex-col items-center"
        >
            <img
        ...
        >
            ...
            <div
                v-if="status"
                class="mb-6 p-4 bg-green-50 rounded-lg text-green-700 text-sm"
            >
                {{ status }}
            </div>
                ...
                <div ref="formElements" class="block">
                    <label class="flex items-center">
                        <Checkbox
                            ...
                            name="remember"
                            class="rounded border-gray-300 text-[#bea55a] focus:ring-[#bea55a]"
                        />
