...
watch(
    notaAcessibilidade,
    (value) => (form.nota_acessibilidade = parseFloat(value)),
);
...
const submitAvaliacao = () => {
    ...
    if (props.isNew) {
        ...
        if (!avaliacaoId) {
            console.error(
                "ID da avaliação não encontrado. Verifique os props.",
            );
            return;
        }
...
const getNoteTooltip = (nota) => {
    ...
    switch (grade) {
        case "A+":
        case "A":
            return "Excelente: Condições ideais sem necessidade de melhorias";
        case "B":
            return "Ótimo: Condições muito boas com pequenas melhorias necessárias";
        case "C":
            return "Bom: Condições adequadas com algumas melhorias recomendadas";
        case "D":
            return "Satisfatório: Condições básicas atendidas, melhorias necessárias";
        case "E":
            return "Regular: Atende minimamente, melhorias significativas necessárias";
        case "F":
            return "Insuficiente: Não atende adequadamente, melhorias urgentes";
        case "G":
            return "Ruim: Condições precárias, necessidade de intervenção";
        case "H":
            return "Muito Ruim: Condições críticas, intervenção imediata";
        case "I":
            return "Péssimo: Condições extremamente precárias, risco à segurança";
        case "J":
            return "Crítico: Inapto para uso, riscos severos à segurança";
        default:
            return "";
    }
};
...
<template>
    ...
    <div class="w-full mx-auto">
        ...
        <div
            ...
            class="bg-yellow-50 border border-yellow-200 p-4 rounded-lg space-y-6"
        >
            <p class="text-yellow-700 text-center">
                Somente unidades com o formulário "Aprovado" podem ser
                avaliadas.
            </p>
        </div>
        ...
        <form v-else @submit.prevent="submitAvaliacao" class="space-y-6">
            <div class="p-6 rounded-lg shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Nota Geral -->
                    <div
                        class="bg-gray-50 border border-gray-200 p-4 rounded-lg transition-all duration-300"
                    >
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <span
                                    :class="getNotaClass(notaGeral)"
                                    class="text-sm font-medium p-1 px-2 rounded-md"
                                    :title="getNoteTooltip(notaGeral)"
                                >
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            {{ getNoteTooltip(notaGeral) }}
                        </p>
                        <InputError
                            :message="form.errors.nota_geral"
                            class="mt-2"
                        />
                    </div>
                    ...
                    >
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <span
                                    :class="getNotaClass(notaEstrutura)"
                                    class="text-sm font-medium p-1 px-2 rounded-md"
                                    :title="getNoteTooltip(notaEstrutura)"
                                >
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            Avalie a qualidade da estrutura física do imóvel
                        </p>
                        <InputError
                            :message="form.errors.nota_estrutura"
                            class="mt-2"
                        />
                    </div>
                    ...
                    >
                        <div class="flex justify-between items-center mb-2">
                            <InputLabel
                                for="nota_acessibilidade"
                                value="Nota Acessibilidade"
                                class="text-base"
                            />
                            <div class="flex items-center">
                                <span class="text-xl font-bold mr-2">{{
                                ...
                                <span
                                    :class="getNotaClass(notaAcessibilidade)"
                                    class="text-sm font-medium p-1 px-2 rounded-md"
                                    :title="getNoteTooltip(notaAcessibilidade)"
                                >
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            Avalie os recursos de acessibilidade disponíveis
                        </p>
                        <InputError
                            :message="form.errors.nota_acessibilidade"
                            class="mt-2"
                        />
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-5 gap-2 text-xs">
                        <div
                            class="bg-green-600 text-white p-1 rounded text-center"
                        >
                            A (9.0-10.0)<br />Excelente
                        </div>
                        <div
                            class="bg-green-500 text-white p-1 rounded text-center"
                        >
                            B-C (7.0-8.9)<br />Bom
                        </div>
                        <div
                            class="bg-yellow-500 text-white p-1 rounded text-center"
                        >
                            D-E (5.0-6.9)<br />Regular
                        </div>
                        <div
                            class="bg-orange-500 text-white p-1 rounded text-center"
                        >
                            F-G (3.0-4.9)<br />Ruim
                        </div>
                        <div
                            class="bg-red-500 text-white p-1 rounded text-center"
                        >
                            H-J (1.0-2.9)<br />Crítico
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <InputLabel
                        for="observacoes"
                        value="Observações e Recomendações"
                    />
                    <textarea
                        id="observacoes"
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        Descreva os pontos fortes e fracos, bem como
            ...
            <!-- Botões de ação -->
            <div
                class="flex items-center justify-end bg-gray-50 p-4 rounded-lg"
            >
                <button
                    type="button"
                ...
                <PrimaryButton
                    :class="{
                        'opacity-25':
                            form.processing || (recentlySaved && props.isNew),
                    }"
                    :disabled="
                        form.processing || (recentlySaved && props.isNew)
                    "
