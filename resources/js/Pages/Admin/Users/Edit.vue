        ...
        <template #header>
            <div class="flex items-center space-x-4">
                ...
                <span class="text-white text-xl font-semibold pl-2"
                    >ENGENHARIA - Editar Usuário</span
                >
            </div>
        </template>
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <FormSection @submitted="updateUser">
                    ...
                    <template #description>
                        Atualize as informações do usuário no sistema. Defina
                        suas informações básicas, lotação e permissões.
                    </template>
                    ...
                    <template #form>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel
                                for="password"
                                value="Nova Senha (deixe em branco para manter a atual)"
                                class="flex items-center"
                            >
                                <LockClosedIcon
                                    class="h-5 w-5 text-gray-400 mr-2"
