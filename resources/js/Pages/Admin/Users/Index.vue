...
<template>
    <AppLayout title="Gerenciar Usuários">
        <template #header>
            <div class="flex items-center space-x-4">
                ...
                <span class="text-white text-xl font-semibold pl-2"
                    >ENGENHARIA - Gerenciar Usuários</span
                >
            </div>
        </template>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <Link
                                                            ...
                                                            "
                                                            class="text-base font-medium text-[#bea55a] hover:texte-[#d4bf7a]"
                                                        >
                                                            {{ user.name }}
                                                        </Link>
                                                    </td>
                                                    ...
                                                    >
                                                        <span
                                                            class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-amber-100 text-black"
                                                        >
                                                            {{
                                                                formatRole(
                                                                    user.role,
        ...
        <DialogModal :show="confirmingUserDeletion" @close="closeModal">
            <template #title> Excluir Usuário </template>
