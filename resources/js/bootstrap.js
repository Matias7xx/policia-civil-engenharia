...
const updateOnlineStatus = () => {
    ...
    if (!navigator.onLine) {
        console.warn('Aplicação offline - algumas funcionalidades podem não estar disponíveis');
    }
};
...
window.formatters = {
    ...
    date: (value) => value ? new Intl.DateTimeFormat('pt-BR').format(new Date(value)) : '',
