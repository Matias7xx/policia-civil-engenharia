...
const unidadeRoute = computed(() => {
    ...
    const unidade = page.props.auth.unidades?.find(
        (u) => u.team_id === user.current_team_id,
    );
    if (unidade && !unidade.is_draft) {
        return route("unidades.show", {
...
const isUnidadeRouteActive = computed(() => {
    return (
        route().current("unidades.show") || route().current("unidades.create")
    );
});
...
const isAuditoriaRouteActive = computed(() => {
    return (
        route().current("admin.auditoria.index") ||
    ...
    <div class="min-h-screen flex flex-col bg-gray-100">
        ...
        >
            ...
            <div class="bg-black text-white py-1 text-xs">
                <div
                    class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end"
                >
                    <a
                        href="mailto:dieri.dg@pc.pb.gov.br"
                        class="inline-flex items-center text-[#bea55a] hover:text-[#d4bf7a] transition-colors"
                    >
                        <svg
            ...
            >
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center">
                        ...
                        <div
                            class="hidden sm:flex sm:items-center sm:ml-6 space-x-2"
                        >
                            <!-- Teams Dropdown -->
                            <Dropdown
                                v-if="
                                                ...
                                                >
                                                    <DropdownLink as="button">
                                                        ...
                                                        >
                                                            <svg
                                                                v-if="
                                                                    ...
                                                                    $page.props
                                                                        ...
                                                                        .current_team_id
                                                                "
                                                                class="mr-2 h-5 w-5 text-[#bea55a]"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                                stroke-width="1.5"
                                                            ...
                                                            <span
                                                                class="truncate max-w-[180px] text-gray-700 hover:text-[#bea55a]"
                                                            >
                                                                {{ team.name }}
                                                            </span>
                                                        </div>
                ...
                <div
                    ...
                    class="sm:hidden bg-[#bea55a] absolute w-full left-0 shadow-lg border-t border-[#816d33] z-50 transition-all duration-300"
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <template v-if="isSuperAdmin">
                            <ResponsiveNavLink
                                :href="route('admin.unidades.index')"
                                :active="
                                    route().current('admin.unidades.index')
                                "
                                class="text-black hover:text-white hover:bg-[#816d33] transition-colors duration-150 block px-3 py-2 rounded-md text-base font-medium"
                            >
                                Unidades
                    ...
                    <div
                        ...
                        class="pt-4 pb-1 border-t border-[#816d33]"
                    >
                        ...
                        <div
                            class="mt-3 space-y-1 border-t border-[#816d33] pt-2"
                        >
                            <ResponsiveNavLink
                                :href="route('profile.show')"
